      ...
      <div className="mt-16 w-full lg:max-w-[954px]">
        <div className="flex w-full flex-col items-center justify-center p-8 pt-4 xs:p-12 xs:pt-12">
          <h1 className="text-center text-5xl font-semibold leading-[1] -tracking-[1px] sm:text-6xl lg:-tracking-[1.8px]">
            What will you{' '}
            <span className="font-editorial font-normal italic tracking-normal text-[#699A6A]">write</span> today?
          </h1>
          
          <span className="text-wrap max mb-8 mt-2 text-center text-xl font-medium tracking-tight text-gray-900 sm:text-2xl">
          ...
          <div className="flex w-full flex-col items-center justify-center sm:w-2/3">
            <Link className="relative z-10 w-full" href="/auth/signin">
              <button className="flex w-full flex-row items-center justify-center gap-2 rounded-2xl bg-black px-8 py-2.5 text-base text-white transition hover:scale-105 active:scale-100 sm:px-16 sm:py-4 sm:text-lg">
            ...
            <div className="relative z-0 flex w-full max-w-[90%] flex-col items-start justify-start gap-2 overflow-hidden rounded-b-2xl bg-gray-100 p-6 pt-4 shadow-lg ring-1 ring-black/5">
              ...
              <div className="flex w-full flex-row items-center justify-center gap-2">
                {writers.slice(0, 2).map((writer) => (
                  <button key={writer.name} className="flex w-full flex-row items-center justify-start gap-2 overflow-hidden rounded-lg bg-white p-2 ring-1 ring-black/5">
                    <Image
                      src={writer.image}
                      alt={writer.name}
                      width={32}
...
const writers = [
  { 
    ...
    followers: '545k', 
    platform: 'linkedin',
    image: 'https://img.freepik.com/premium-vector/people-saving-money_24908-51568.jpg?semt=ais_hybrid' 
  },
  { 
    name: 'Dickie Bush', 
    followers: '489k', 
